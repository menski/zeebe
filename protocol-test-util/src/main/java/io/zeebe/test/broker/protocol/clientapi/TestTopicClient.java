...
public class TestTopicClient
{
    ...
    public static Predicate<SubscribedRecord> workflowEvents(Intent intent)
    {
        return workflowRecords().and(recordType(RecordType.EVENT)).and(intent(intent));
    }

    public static Predicate<SubscribedRecord> workflowRecords()
    {
        return e -> e.valueType() == ValueType.WORKFLOW;
    }
