...
public class ClusterBaseLayerServiceNames {
  ...
  public static final ServiceName<Partition> FOLLOWER_PARTITION_SYSTEM_GROUP_NAME =
      ServiceName.newServiceName("cluster.base.followerGroup.system", Partition.class);
